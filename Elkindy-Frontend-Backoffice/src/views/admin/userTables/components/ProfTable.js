                ...
                <Modal isOpen={isModalOpenP} onClose={closeModalP}>
                    ...
                    <ModalContent>
                        <form onSubmit={handleSubmit} noValidate>
                            <ModalHeader>Add Professor</ModalHeader>
                            <ModalCloseButton />
                            <ModalBody>
            ...
            <Modal isOpen={isModalViewOpen} onClose={closeModalViewA}>
                ...
                <ModalContent maxW={'800px'}>
                    ...
                    <ModalBody>
                        {profInfo && (
                            <>
                                <img src={profInfo.profilePicture} alt="Profile Picture" style={{ maxWidth: "250px", maxHeight: "250px", borderRadius: "50%", margin: "auto" }} />
